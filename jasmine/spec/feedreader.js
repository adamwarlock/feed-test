...
$(function () {
    ...
    describe('RSS Feeds', function () {
         ...
         */
        it('URL of allFeeds not empty', function () {
            for (x in allFeeds) {
         ...
         */
        it('names of allFeeds not empty', function () {
            for (x in allFeeds) {
    ...
    describe('Initial Entries', function () {
        ...
        it('feed has atleast 1 Entry', function (done) {
    ...
    describe('NEW feed Selection', function () {
        ...
        it('feed loading or not', function () {
            new_feed = $('.feed').html();
            expect(init_feed).not.toEqual(new_feed);
        });
